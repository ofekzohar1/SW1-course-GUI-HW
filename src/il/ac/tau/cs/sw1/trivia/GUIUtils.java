...
public class GUIUtils {
     ...
     */
    public static void showInfoDialog(Shell shell, String title, String message) {
     ...
     */
    private static void showDialog(Shell shell, String title, String message, int icon) {
